...
if [ -z "$VIRTUAL_ENV" ]; then
  echo "This requires the two python virtual environment."
...
# Allows overriding the branch or commit to build in two-blockchain-gui
SUBMODULE_BRANCH=$1
...
echo ""
echo "Type 'cd two-blockchain-gui' and then 'npm run electron &' to start the GUI."
