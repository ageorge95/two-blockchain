...
Write-Output "https://keybase.io/team/two_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running two-blockchain:"
Write-Output "https://github.com/Chia-Network/two-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'two init' to begin."
