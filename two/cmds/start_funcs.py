...
from two.cmds.passphrase_funcs import get_current_passphrase
from two.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from two.util.keychain import KeyringMaxUnlockAttempts
from two.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, group: str, restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the two daemon")
        return None
