...
from two.cmds.configure import configure_cmd
from two.cmds.farm import farm_cmd
from two.cmds.init import init_cmd
from two.cmds.keys import keys_cmd
from two.cmds.netspace import netspace_cmd
from two.cmds.passphrase import passphrase_cmd
from two.cmds.plotnft import plotnft_cmd
...
from two.util.default_root import DEFAULT_KEYS_ROOT_PATH, DEFAULT_ROOT_PATH
from two.util.keychain import set_keys_root_path, supports_keyring_passphrase
from two.util.ssl_check import check_ssl
...
@click.group(
    help=f"\n  Manage two blockchain infrastructure ({DIST_NAME} {__version__})\n",
    epilog="Try 'two start node', 'two netspace -d 192', or 'two show -s'",
...
def cli(
    ...
    if passphrase_file is not None:
        from two.cmds.passphrase_funcs import cache_passphrase, read_passphrase_from_file
