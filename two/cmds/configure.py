...
from two.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "12322"
            testnet_introducer = "beta1_introducer.twochain.top"
            testnet_dns_introducer = "dns-introducer-testnet0.twochain.top"
            testnet = "testnet0"
            ...
            mainnet_port = "23333"
            mainnet_introducer = "introducer.twochain.top"
            mainnet_dns_introducer = "dns-introducer.twochain.top"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running two services for changes to take effect")
