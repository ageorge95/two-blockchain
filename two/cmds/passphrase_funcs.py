...
from two.daemon.client import acquire_connection_to_daemon
from two.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
from two.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from two.util.misc import prompt_yes_no
from two.util.ws_message import WsRpcMessage
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'two passphrase set' or 'two passphrase remove' to update or remove your passphrase")
        sys.exit(1)
