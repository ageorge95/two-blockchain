...
from two.types.blockchain_format.program import Program, INFINITE_COST
from two.types.condition_opcodes import ConditionOpcode
from two.types.spend_bundle import SpendBundle
from two.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "two" in cc_discrepancies:
                    cc_discrepancies["two"] = cc_discrepancies["two"] + diff
                else:
                    cc_discrepancies["two"] = diff
