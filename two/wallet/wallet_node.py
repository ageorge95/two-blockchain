...
from two.daemon.keychain_proxy import (
    KeychainProxy,
...
from two.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH
from two.protocols import farmer_protocol, wallet_protocol
from two.protocols.full_node_protocol import RequestProofOfWeight, RespondProofOfWeight
from two.protocols.protocol_message_types import ProtocolMessageTypes
from two.protocols.wallet_protocol import (
...
from two.server.node_discovery import WalletPeers
from two.server.outbound_message import Message, NodeType, make_msg
from two.server.server import ChiaServer
from two.server.ws_connection import WSChiaConnection
from two.types.blockchain_format.coin import Coin, hash_coin_list
...
from two.types.peer_info import PeerInfo
from two.util.byte_types import hexstr_to_bytes
from two.util.check_fork_next_block import check_fork_next_block
from two.util.errors import Err, ValidationError
from two.util.ints import uint32, uint64, uint128
from two.util.keychain import Keychain
from two.util.lru_cache import LRUCache
from two.util.merkle_set import MerkleSet, confirm_included_already_hashed, confirm_not_included_already_hashed
...
from two.wallet.settings.settings_objects import BackupInitialized
...
from two.wallet.wallet_blockchain import ReceiveBlockResult
from two.wallet.wallet_state_manager import WalletStateManager
...
class WalletNode:
    ...
    async def get_key_for_fingerprint(self, fingerprint: Optional[int]) -> Optional[PrivateKey]:
        ...
        try:
            ...
            self.log.warning("No keys present. Create keys with the UI, or with the 'two keys' program.")
            return None
