...
from two.util.keyring_wrapper import KeyringWrapper

CURRENT_KEY_VERSION = "1.8"
DEFAULT_USER = f"user-two-{CURRENT_KEY_VERSION}"  # e.g. user-two-1.8
DEFAULT_SERVICE = f"two-{DEFAULT_USER}"  # e.g. two-user-two-1.8
...
def obtain_current_passphrase(prompt: str = DEFAULT_PASSPHRASE_PROMPT, use_passphrase_cache: bool = False) -> str:
    ...
    before failing.
    """
    from two.cmds.passphrase_funcs import prompt_for_passphrase
