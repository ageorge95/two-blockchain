...
from two.daemon.server import service_launch_lock_path, singleton
from two.server.ssl_context import two_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"two_{service_name}"
        ...
        two_ca_crt, two_ca_key = two_ssl_ca_paths(root_path, self.config)
