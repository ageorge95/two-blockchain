...
testnet_kwargs = {
    ...
    # Forks of two should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("839793d9e66b32940ac0ff383e520fcb3b8ec89b0be8291a5558da3a785cd668"),
