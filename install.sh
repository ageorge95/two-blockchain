...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	...
	echo "https://github.com/xone-network/two-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
echo "https://keybase.io/team/two_network.public"
echo ""
echo "Try the Quick Start Guide to running two-blockchain:"
echo "https://github.com/xone-network/two-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'two init' to begin."
