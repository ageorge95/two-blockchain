...
Write-Output "   ---"
git clean -fdx
Set-Location -Path ".\two-blockchain-gui" -PassThru
git clean -fdx
...
Write-Output "   ---"
Write-Output "Build two-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install two-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install two-blockchain"
pip install --no-index --find-links=.\win_build\ two-blockchain

Write-Output "   ---"
Write-Output "Use pyinstaller to create two .exe's"
Write-Output "   ---"
$SPEC_FILE = (python -c 'import two; print(two.PYINSTALLER_SPEC_PATH)') -join "`n"
pyinstaller --log-level INFO $SPEC_FILE

Write-Output "   ---"
Write-Output "Copy two executables to two-blockchain-gui\"
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\two-blockchain-gui\" -Recurse
