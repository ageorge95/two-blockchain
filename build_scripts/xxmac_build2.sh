...
APP_VERSION=$1
APP_BUNDLEID="top.twochain.blockchain"
APP_NAME="SIT"
...
#   --hardened-runtime=true --provisioning-profile=twoblockchain.provisionprofile \
...
# notarize-cli --file=$DMG_NAME.dmg --bundle-id top.twochain.blockchain --username "williejonagvio38@gmail.com" --password "mrdo-yfcr-intb-eyxr"
